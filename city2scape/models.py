...
if __name__ == "__main__":
    ...
    net.load_state_dict(torch.load("outputs/moo-sam/data_path=PosixPathdata/n_epochs=200/batch_size=8/lr=0.0002/seed=0/model=mtan/method=cagrad/adaptive=True/rho=0.001/apply_augmentation=True/c=0.4/30.pth", map_location=torch.device('cpu')))
